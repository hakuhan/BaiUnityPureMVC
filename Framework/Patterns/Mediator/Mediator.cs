...
namespace PureMVC
{
    ...
    public class Mediator : Notifier, IMediator, INotifier
	{
		...
		public Mediator(string mediatorName, IBaseView viewComponent)
		{
        ...
        ///     </example>
        /// </remarks>
        public virtual IBaseView GetViewComponent()
        ...
        ///     </example>
        /// </remarks>
        public virtual void SetViewComponent(IBaseView value)
        { m_viewComponent = value; }


        public virtual void AddChildComponent(IBaseView _childC)
        {
            if (!m_childComponents.Contains(_childC))
                m_childComponents.Add(_childC);
        }
        ...
        /// <summary>
        /// Sub component of view component
        /// </summary>
        protected List<IBaseView> m_childComponents = new List<IBaseView>();
