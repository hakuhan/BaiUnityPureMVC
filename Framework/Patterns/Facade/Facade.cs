...
namespace PureMVC
{
    ...
    ///     </example>
    /// </remarks>
	/// <see cref="PureMVC.Model"/>
	/// <see cref="PureMVC.View"/>
	/// <see cref="PureMVC.Controller"/>
	/// <see cref="PureMVC.Notification"/>
	/// <see cref="PureMVC.Mediator"/>
	/// <see cref="PureMVC.Proxy"/>
	/// <see cref="PureMVC.SimpleCommand"/>
	/// <see cref="PureMVC.MacroCommand"/>
    public class Facade : IFacade
	{
        ...
        public virtual void NotifyObservers(INotification notification)
		{
            // The view is initialized in the constructor of the singleton, so this call should be thread safe.
            // This method is thread safe on the view.
            Debug.Log("Send Notice:" + notification.Name);
